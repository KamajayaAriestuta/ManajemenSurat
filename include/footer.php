...
?>
    ...
    <footer class="page-footer">
        ...
        <div class="footer-copyright red darken-2 white-text">

            <div class="cop" align="center">
                <a href="https://kumtala.ub.ac.id/" target="_blank" style="text-decoration: none; color:white;">Divisi HTL Universitas Brawijaya</a>
            </div>
